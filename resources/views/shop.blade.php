                ...
                <div class="row g-4">
                    <div class="col-lg-12">
                        ...
                        <div class="row g-4">
                                ...
                                <div class="row g-4">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li data-cat_id="{{$cat->id}}" class="category_li">
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="javascript:void(0);"><i class="fas fa-apple-alt me-2"></i>{{$cat->name}}</a>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <output id="amount" name="amount" min-velue="0" max-value="100000" for="rangeInput">0</output>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-2">
                                                <input type="radio" class="me-2" id="Categories-1" name="sub_category" value="{{$sub_cat->id}}">
                            ...
                            <div class="col-lg-9">
                                <div class="product-search-loader" id="loader" style="display: none;">
...
<script>
    $(document).on('click','input[name=sub_category]',function(e){
     ...
     $(document).on('click','input[name=rangeInput]',function(e){
        var range = $(this).val();
        var data = {range: range}; 
        getProducts(data)
    })

     $(document).on('click','.category_li',function(e){
